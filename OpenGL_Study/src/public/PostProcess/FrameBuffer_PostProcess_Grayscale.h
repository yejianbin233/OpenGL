...
// 使用索引定义多个面，可形成立体。
namespace FrameBufferPostProcessGrayscaleRendering
{
    static int FrameBufferPostProcessGrayscaleRenderingRun()
    {
        ...
        Shader screenShader("src/Shaders/VertexShaders/PostProcess/FrameBuffer_PostProcess_Screen.vs", "src/Shaders/FragmentShaders/PostProcess/FrameBuffer_PostProcess_Screen_Grayscale.fs");
