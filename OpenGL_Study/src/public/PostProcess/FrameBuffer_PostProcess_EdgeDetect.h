...
// 使用索引定义多个面，可形成立体。
namespace FrameBufferPostProcessEdgeDetectRendering
{
    static int FrameBufferPostProcessEdgeDetectRenderingRun()
    {
        ...
        Shader screenShader("src/Shaders/VertexShaders/PostProcess/FrameBuffer_PostProcess_Screen.vs", "src/Shaders/FragmentShaders/PostProcess/FrameBuffer_PostProcess_Screen_EdgeDetect.fs");
