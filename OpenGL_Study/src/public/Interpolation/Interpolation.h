...
namespace InterpolationRendering
{
    static int InterpolationRenderingRun()
    {
        ...
        glBufferData(GL_ARRAY_BUFFER, sizeof(geometry_vertices_data::triangles::simple), geometry_vertices_data::triangles::simple, GL_STATIC_DRAW); 
        ...
        *   layout (location = 0) in vec3 aPos;
        ...
        // -- 着色器（Shader） --
        Shader ourShader("src/Shaders/VertexShaders/Interpolation.vs", "src/Shaders/FragmentShaders/Interpolation.fs");
        ourShader.use();
        // -- 着色器（Shader）  --
