...
namespace PhongAndBlinnPhongRendering
{
    static int PhongAndBlinnPhongRenderingRun()
    {
        ...
        // -------------------------
        Shader shader("src/Shaders/VertexShaders/Lighting/PhongAndBlinnPhong.vs", "src/Shaders/FragmentShaders/Lighting/PhongAndBlinnPhong.fs");
