...
namespace ShadowMappingRendering
{
    static int ShadowMappingRenderingRun()
    {
    ...
    glfwWindowHint(GLFW_OPENGL_FORWARD_COMPAT, GL_TRUE);
        ...
        // -------------------------
        Shader shader("src/Shaders/VertexShaders/Lighting/Shadow/ShadowMapping.vs", "src/Shaders/FragmentShaders/Lighting/Shadow/ShadowMapping.fs");
