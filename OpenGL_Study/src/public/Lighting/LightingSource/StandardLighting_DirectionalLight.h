...
// 使用索引定义多个面，可形成立体。
namespace StandardLightingDirectionalLightRendering
{
    static int StandardLightingDirectionalLightRenderingRun()
    {
        ...
        // -- 着色器（Shader） --
        Shader lightingShader("src/Shaders/VertexShaders/Lighting/LightingSource/StandardLighting_DirectionalLight.vs", "src/Shaders/FragmentShaders/Lighting/LightingSource/StandardLighting_DirectionalLight.fs");
        // -- 着色器（Shader）  --
