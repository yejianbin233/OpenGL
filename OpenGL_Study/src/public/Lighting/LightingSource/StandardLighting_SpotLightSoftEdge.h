...
// 使用索引定义多个面，可形成立体。
namespace StandardLightingSpotLightSoftEdgeRendering
{
    static int StandardLightingSpotLightSoftEdgeRenderingRun()
    {
        ...
        // -- 着色器（Shader） --
        Shader lightingShader("src/Shaders/VertexShaders/Lighting/LightingSource/StandardLighting_SpotLight.vs", "src/Shaders/FragmentShaders/Lighting/LightingSource/StandardLighting_SpotLightSoftEdge.fs");
        // -- 着色器（Shader）  --
