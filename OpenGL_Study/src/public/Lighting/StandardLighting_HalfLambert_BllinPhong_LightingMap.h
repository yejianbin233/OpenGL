...
// 光照贴图
namespace StandardLightingHalfLambertBllinPhongLightingMapRendering
{
    static int StandardLightingHalfLambertBllinPhongLightingMapRenderingRun()
    {
        ...
        // -- 着色器（Shader） --
        Shader lightingShader("src/Shaders/VertexShaders/Lighting/StandardLighting_HalfLambert_BlinnPhong_LightingMap.vs", "src/Shaders/FragmentShaders/Lighting/StandardLighting_HalfLambert_BlinnPhong_LightingMap.fs");
