...
// 使用索引定义多个面，可形成立体。
namespace StandardLightingHalfLambertBllinPhongDynamicRendering
{
    static int StandardLightingHalfLambertBllinPhongDynamicRenderingRun()
    {
        ...
        // -- 着色器（Shader） --
        Shader lightingShader("src/Shaders/VertexShaders/Lighting/StandardLighting.vs", "src/Shaders/FragmentShaders/Lighting/StandardLighting_HalfLambert_BlinnPhong.fs");
