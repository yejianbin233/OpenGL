...
namespace TextureBlendVertexColorRendering
{
    static int TextureBlendVertexColorRenderingRun()
    {
        ...
        glBufferData(GL_ARRAY_BUFFER, sizeof(geometry_vertices_data::square::simpleWithVertexColorTexCoord), geometry_vertices_data::square::simpleWithVertexColorTexCoord, GL_STATIC_DRAW); 
        ...
        *   layout (location = 0) in vec3 aPos;
        ...
        // -- 着色器（Shader） --
        Shader ourShader("src/Shaders/VertexShaders/TextureBlendVertexColor.vs", "src/Shaders/FragmentShaders/TextureBlendVertexColor.fs");
        // -- 着色器（Shader）  --
